...
Snapshotin aktiiviseksi palautuksen turvaraja tulkitsee kaikki V1/V2/V3-tapahtumat fyysiseksi tuotannoksi. Myös `completedBarIds` estää palautuksen konservatiivisesti, koska merkintä tarkoittaa salon käsittelyn valmistumista eikä pelkkää luonnoksen käyttöliittymätilaa. Tämä esto koskee sekä nykyistä aktiivista työtä että palautettavaa snapshotia; se ei estä snapshotin read-only-katselua. Fyysisen tilanteen sovittaminen vanhaan tallenteeseen kuuluu erilliseen B-015-työhön.
