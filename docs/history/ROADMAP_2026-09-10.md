...
Sovellus muodostaa nyt avoimista tilauksista diskreetin tuotantobatchin (8.9.2026). Kokonaiset tilaukset valitaan materiaalipisteen perusteella, nykyinen inventory-aware optimizer tekee materiaaliratkaisun ja erillinen scheduler muodostaa nippusahausoperaatiot. Tilaus-/aukkokohdistus säilyy kappaleissa. Toteutuksen auktoritatiiviset säännöt ja rajat: [nykyinen tuotantomalli](../domain/PRODUCTION.md) (aiempi tuotantosuunnitteludokumentti).
